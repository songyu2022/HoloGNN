...
# load_model_dict(model, './model/20250715_163830_GIGN_repeat0/model/epoch-391, train_loss-0.1383, train_rmse-0.3719, valid_rmse-1.1525, valid_pr-0.7824.pt')
# load_model_dict(model, './model/20250715_171953_GIGN_repeat1/model/epoch-396, train_loss-0.1503, train_rmse-0.3877, valid_rmse-1.1686, valid_pr-0.7774.pt')
load_model_dict(model, './model/20250715_180128_GIGN_repeat2/model/epoch-194, train_loss-0.2344, train_rmse-0.4841, valid_rmse-1.1544, valid_pr-0.7829.pt')
model = model.cuda()
