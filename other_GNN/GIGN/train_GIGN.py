...
if __name__ == '__main__':
    ...
    print(f'early_stop_epoch is {early_stop_epoch}')

    for repeat in range(repeats):
        args['repeat'] = repeat

        # train_dir = os.path.join(data_root, 'PDB_train_13634')
        # valid_dir = os.path.join(data_root, 'PDB_valid_1000')
        # test2013_dir = os.path.join(data_root, 'PDB_test2013_107')
        # test2016_dir = os.path.join(data_root, 'PDB_test2016_285')
        # test2019_dir = os.path.join(data_root, 'PDB_test2019_4362')

        # train_df = pd.read_csv(os.path.join(data_root, 'train_13634.csv'))
        # valid_df = pd.read_csv(os.path.join(data_root, 'valid_1000.csv'))
        # test2013_df = pd.read_csv(os.path.join(data_root, 'test2013_107.csv'))
        # test2016_df = pd.read_csv(os.path.join(data_root, 'test2016_285.csv'))
        # test2019_df = pd.read_csv(os.path.join(data_root, 'test2019_4362.csv'))
        ...
        train_set = GraphDataset(train_dir, train_df, graph_type='Graph_GIGN', create=False)
