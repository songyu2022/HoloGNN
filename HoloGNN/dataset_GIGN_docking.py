...
if __name__ == '__main__':
    ...
    data_root = './data'
    toy_dir = os.path.join(data_root, docking_dir)
    toy_df = pd.read_csv(os.path.join(data_root, csv_file))
    toy_set = GraphDataset(toy_dir, toy_df, graph_type='Graph_HoloGNN', dis_threshold=5, create=True)
